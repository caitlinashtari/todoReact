	...
	exports.default = function () {
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(_reactRouter.Route, { path: 'add_todo', component: _addTodo2.default })
	    )
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } //extends component so you don't have tolater
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'h1',
	          null,
	          'Bryan is a cotton headed ninny muggins'
	        ),
	        this.props.children
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todosActions = __webpack_require__(211);

	var _todosActions2 = _interopRequireDefault(_todosActions);

	var _todosStore = __webpack_require__(212);
	...
	var IndexComponent = function (_Component) {
	  ...
	  function IndexComponent(props) {
	    ...
	    _this.setTodos = _this.setTodos.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(IndexComponent, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      _todosStore2.default.listen(this.setTodos);
	      _todosActions2.default.loadActions();
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          { onClick: function onClick(e) {
	              return _todosActions2.default.createTodo();
	            } },
	          'New Todo'
	        ),
	        _react2.default.createElement(
	          ...
	          this.state.todos.map(function (item, index) {
	            return _react2.default.createElement(_todos.TodoItem, { key: 'TodoItem-' + index, item: item });
	          })
	        )
	      );
	    }
	    ...
	    value: function componentWillUnmount() {
	      _todosStore2.default.unlisten(this.setTodos);
	    }
	    ...
	    key: 'setTodos',
	    value: function setTodos(TodoStore) {
	      this.setState({
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.TodoItem = exports.TodoList = undefined;
	...
	//giving todos access to extra components
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoItem = function (_Component) {
	  ...
	  function TodoItem(props) {
	    ...
	    _this.state = {
	      checked: _this.props.item.done || false,
	      isEditMode: false
	    };
	  ...
	  _createClass(TodoItem, [{
	    ...
	    value: function handleToggle(e) {
	      if (this.state.isEditMode) _todosActions2.default.updateTodoTitle(this.props.item, e.target.value);
	      this.setState({
	    ...
	    value: function renderInput() {
	      return _react2.default.createElement('input', { type: 'text', onBlur: this.handleToggle, defaultValue: this.props.item.title, autoFocus: true });
	    }
	  }, {
	    key: 'renderTitle',
	  ...
	  _createClass(TodoActions, [{
	    ...
	    value: function loadActions() {
	      return function (dispatch) {
	        _superagent2.default.get('/api/todos').end(function (err, res) {
	    ...
	    value: function createTodo() {
	      return function (dispatch) {
	        _superagent2.default.post('/api/todos').end(function (err, res) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoStore = function () {
	  function TodoStore() {
	    ...
	    this.bindActions(_todosActions2.default);
	  ...
	  _createClass(TodoStore, [{
	    key: 'onLoadActions',
	    value: function onLoadActions(todos) {
	      this.setState({
	        todos: todos
	      });
	    }
	    ...
	    key: 'onCreateTodo',
	    value: function onCreateTodo(todo) {
	    ...
	    key: 'onUpdateTodoTitle',
	    value: function onUpdateTodoTitle(nTodo) {
	      var nState = _extends({}, this.state);

	      nState.todos.forEach(function (todo, i) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _alt = __webpack_require__(214);
	...
	//whenever we want to create a new store or new action we do this so everything shares the same instantiation of Alt
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsStateFunctions = __webpack_require__(218);

	var StateFunctions = _interopRequireWildcard(_utilsStateFunctions);

	var _utilsFunctions = __webpack_require__(219);
	...
	var _utilsAltUtils = __webpack_require__(221);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AltStore = __webpack_require__(222);

	var _AltStore2 = _interopRequireDefault(_AltStore);

	var _StoreMixin = __webpack_require__(224);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _transmitter = __webpack_require__(223);
